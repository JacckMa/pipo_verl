...
PPO_RAY_RUNTIME_ENV = {
    "env_vars": {
        ...
        "HACPO_FAIL_ON_SANDBOX_ERROR": "1",
        "HACPO_TACO_REWARD_MAX_CASES": "0",
        "HACPO_TACO_REWARD_CASE_SELECTION": "hardest",
...
def get_ppo_ray_runtime_env():
    ...
    # These flags must still reach Ray workers even when the launcher exports them.
    for key, default in (
        ("VLLM_ALLREDUCE_USE_SYMM_MEM", "0"),
        ("VLLM_USE_NCCL_SYMM_MEM", "0"),
        ("NCCL_CUMEM_ENABLE", "0"),
        ...
        runtime_env["env_vars"][key] = os.environ.get(key, default)
    return runtime_env
