...
__all__ = ["AlgoConfig", "FilterGroupsConfig", "KLControlConfig", "LaybackConfig", "RolloutCorrectionConfig"]
...
class LaybackConfig(BaseConfig):
    """Configuration for PIPO policy-improvement feedback in SDPO."""

    enable: bool = False
    history_window_size: int = 8
    layback_every_n_steps: int = 1
    min_steps_before_layback: int = 2
