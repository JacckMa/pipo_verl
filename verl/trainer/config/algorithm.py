...
__all__ = ["AlgoConfig", "FilterGroupsConfig", "KLControlConfig", "RolloutCorrectionConfig", "LaybackConfig"]
...
class LaybackConfig(BaseConfig):
    """Configuration for PIPO feedback updates.

    Args:
        enable: Whether to enable PIPO feedback. Defaults to False.
        history_window_size: Size of the rolling reward history window. Defaults to 8.
        layback_every_n_steps: Apply feedback every N steps. Defaults to 1.
        min_steps_before_layback: Minimum history length before applying feedback. Defaults to 8.
        loss_scale_neg: Scale factor for negative xi_t. Defaults to 0.0 (no penalty).
        clip_ratio_high: Optional upper PPO clip ratio for positive feedback updates.
    """
...
class AlgoConfig(BaseConfig):
    ...
    Args:
        ...
        rollout_correction (Optional[RolloutCorrectionConfig]): Rollout Correction configuration.
            ...
            Set to None to disable. Use RolloutCorrectionConfig factory methods for presets.
        layback (LaybackConfig): Two-stage PPO Layback configuration.
    """
    ...
    layback: LaybackConfig = field(default_factory=LaybackConfig)
