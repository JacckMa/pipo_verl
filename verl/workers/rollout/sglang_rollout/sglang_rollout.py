...
class SGLangRollout(BaseRollout):
    ...
    def _batch_level_generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        if not do_sample:
            ...
            # Check for adaptive temperature from meta_info
            if "temperature" in prompts.meta_info:
                request_sampling_params.update({"temperature": prompts.meta_info["temperature"]})
    ...
    async def _async_rollout_a_request(
        ...
        **kwargs,
        ...
        if not do_sample:
            ...
            # Check for adaptive temperature from kwargs (passed from meta_info)
            if "temperature" in kwargs:
                request_sampling_params.update({"temperature": kwargs["temperature"]})
