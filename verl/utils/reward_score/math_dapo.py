...
def compute_score(
    ...
    Returns:
        dict with keys: score (1.0 or -1.0), acc (bool), pred (str)
    """
    # Limit solution length for efficiency
    solution_str = solution_str[-300:]  # The longest answer in MATH-500 has 159 characters

    # Unpack list ground_truth (some datasets store it as ["answer"])
    ...
    try:
        ...
        # Defensive: if any parsing/assertion error occurs, treat as incorrect
        reward, acc, pred = -1.0, False, "[PARSE_ERROR]"
